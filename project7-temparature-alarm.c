...
void loop() {
  ...
  Serial.print(val); // Serial port outputs temperature value

  data = (double)val * (5.0 / 1024.0); // Convert the voltage value to temperature value
  data = data * 100.0; // Convert to Celsius
